...
[`mia::importBIOM()`](https://rdrr.io/pkg/mia/man/importBIOM.html)
function. Here’s a step-by-step example of how to perform this
conversion:
...
`TreeSummarizedExperiment` format, you can use the
[`mia::importQIIME2()`](https://rdrr.io/pkg/mia/man/importQIIME2.html)
function. Here’s a step-by-step example of how to perform this
conversion:
...
`TreeSummarizedExperiment` format, you can use the
[`mia::importMothur()`](https://rdrr.io/pkg/mia/man/importMothur.html)
function. Here’s a step-by-step example of how to perform this
conversion:
...
`TreeSummarizedExperiment` format, you can use the
[`mia::importMetaPhlAn()`](https://rdrr.io/pkg/mia/man/importMetaPhlAn.html)
function. Here’s a step-by-step example of how to perform this
conversion:
...
#>  emmeans                    1.11.2-8   2025-08-27 [1] RSPM (R 4.5.0)
