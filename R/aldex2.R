...
#' correction (Not supported in `dar` package).
#'
#' @details The run_aldex function is a wrapper that performs log-ratio transformation and
...
#' @param denom An any variable (all, iqlr, zero, lvha, median, user) indicating features
