...
description: |
  Start here if this is your first time usinc dar! You will learn about basic 
...
The package contains a data set from 
[Noguera-Julian, M., et al. 2016](https://doi.org/10.1016/j.ebiom.2016.01.032) 
used to find the differential abundant microbial species among men who have sex 
with men (MSM) and non-MSM (hts). The data is stored inside an object of class 
`phyloseq`, the standard input format for creating recipes with dar. We will 
...
will use __metagenomeSeq__, __maaslin2__ and __DESeq2__ methods with default 
parameters (those defined by the authors of each method).
