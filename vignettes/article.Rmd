...
In addition to the preprocessing steps, `recipe_qc()` returns overall or
explicitly grouped metrics that support informed preprocessing decisions.
...
ALDEx2, ANCOM-BC, corncob, DESeq2, Lefse, LinDA, MaAsLin3 and Wilcox.
...
`min_prevalence` parameter to 0 for MAaslin3. This approach ensured that the analysis was consistent across all 
...
```{r intersection-plot, fig.height=5}
## Intersection plot 
