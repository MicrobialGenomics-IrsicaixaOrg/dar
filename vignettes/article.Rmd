...
methods return similar results, DESeq2 and metagenomeSeq have a lower 
correlation with the other methods. This result can also be observed in the 
plot generated by the `intersection_plt()` function, providing a more 
